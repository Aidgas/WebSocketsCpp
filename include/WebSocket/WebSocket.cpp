...
void WebSocket::debugPrintFrameType(int type)
{
    switch(type)
    {
        case CLOSING_FRAME:           printf("frametype -> CLOSING_FRAME\n"); break;
        case BINARY_FRAME:            printf("frametype -> BINARY_FRAME\n"); break;
        case ERROR_FRAME:             printf("frametype -> ERROR_FRAME\n"); break;
        case INCOMPLETE_BINARY_FRAME: printf("frametype -> INCOMPLETE_BINARY_FRAME\n"); break;
        case INCOMPLETE_FRAME:        printf("frametype -> INCOMPLETE_FRAME\n"); break;
        case INCOMPLETE_TEXT_FRAME:   printf("frametype -> INCOMPLETE_TEXT_FRAME\n"); break;
        case OPENING_FRAME:           printf("frametype -> OPENING_FRAME\n"); break;
        case PING_FRAME:              printf("frametype -> PING_FRAME\n"); break;
        case PONG_FRAME:              printf("frametype -> PONG_FRAME\n"); break;
        case TEXT_FRAME:              printf("frametype -> TEXT_FRAME\n"); break;
        default:                      printf("frametype -> NONE\n"); break;
    }
}