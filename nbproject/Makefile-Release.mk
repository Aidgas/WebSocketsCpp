...
${OBJECTDIR}/include/WebSocket/WebSocket.o: include/WebSocket/WebSocket.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/WebSocket/WebSocket.o include/WebSocket/WebSocket.cpp
...
${OBJECTDIR}/include/WebSocket/base64/base64.o: include/WebSocket/base64/base64.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/WebSocket/base64/base64.o include/WebSocket/base64/base64.cpp

${OBJECTDIR}/include/WebSocket/sha1/sha1.o: include/WebSocket/sha1/sha1.cpp
	${MKDIR} -p ${OBJECTDIR}/include/WebSocket/sha1
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/WebSocket/sha1/sha1.o include/WebSocket/sha1/sha1.cpp
